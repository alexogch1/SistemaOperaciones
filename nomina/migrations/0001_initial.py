# Generated by Django 2.2.6 on 2020-02-16 13:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_concepto', models.CharField(blank=True, choices=[('PERSEPCION', 'PERCEPCION'), ('DEDUCCION', 'DEDUCCION')], max_length=30, null=True)),
                ('uc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
