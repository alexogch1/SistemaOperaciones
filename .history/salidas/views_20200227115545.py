...
class TiempoMuertoView(SinPrivilegios, generic.ListView):
    ...
    def get(self, request, *args,**kwargs):
        ...
        obj = TiempoMuertoEnc.objects.filter(fecha_produccion__gte=initial_date, fecha_produccion__lte=final_date )
        return obj= TiempoMuertoEnc.objects.filter(fecha_produccion__gte=initial_date, fecha_produccion__lte=final_date )
