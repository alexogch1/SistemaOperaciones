...
from.reportes_excel import ReporteTmXls,ReporteProdEmbXls
...
urlpatterns = [
    ...
    path('salidas/produccion_embolsados_completo_excel', ReporteProdEmbXls.as_view(), name="produccion_emb_completos_excel"),
