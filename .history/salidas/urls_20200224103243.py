...
urlpatterns = [
    ...
    path('salidas/tiempo_muerto_completo_excel', TiempoMuertoCompletoList.as_view(), name="tiempos_muertos_completos"),
    ...
    path('salidas/tiempo_muerto_completo', TiempoMuertoCompletoXls.as_view(), name="tiempos_muertos_completos_excel"),
